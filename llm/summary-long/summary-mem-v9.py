...
<output_format>
Present the enhanced summary using the existing structure of the current summary. Add new information or corrections where appropriate, clearly marking additions with [ADDED] tags and corrections with [CORRECTED] tags. For example:

Enhanced Summary:
- Main topic 1
  • Sub-topic 1.1
  • [CORRECTED] Accurate sub-topic 1.2
  • [ADDED] New sub-topic 1.3 from original document

- Main topic 2
  • Sub-topic 2.1
  • [CORRECTED] Accurate sub-topic 2.2
  • [ADDED] New sub-topic 2.3 from original document

- Main topic 3
  • Sub-topic 3.1
  • Sub-topic 3.2
  • [ADDED] New sub-topic 3.3 from original document
