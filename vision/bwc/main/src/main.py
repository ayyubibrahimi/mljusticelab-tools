...
VIDEO_DIR = "../../audio/data/input"  # Assuming this is where your video files are stored
    ...
    for filename in os.listdir(INPUT_DIR):
        if filename.endswith('.json'):
            ...
            if start_time is not None and end_time is not None:
                # Assuming the video file has the same name as the JSON file, but with a different extension
                video_filename = os.path.splitext(filename)[0] + '.mp4'  # or whatever video format you're using
            ...
            print()  # Add a blank line for readability between file processing
